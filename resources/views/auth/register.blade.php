        ...
        <div class="box__register">
            ...
            @csrf
                <div class="form__username">
                    ...
                    <input class="input__username" type="text" name="name" id="name" placeholder="Username">
                </div>
                @error('name')
                ...
                <div class="form__email">
                    ...
                    <input class="input__email" type="email" name="email" id="email" placeholder="Email">
                ...
                <div class="form__password">
                    ...
                    <input class="input__password" type="password" name="password" id="password" placeholder="Password">
            ...
            <div class="button__outer">
                <button class="outer-button" type="submit" form="register">登録</button>
            </div>
        </div>
    </div>
@endsection
